...
class Kit:
    def __init__(self, data:bytearray):
        ...
        self.set_shorts_number()
        self.set_overlay_type()
        self.set_y_position_long_sleeve_overlay()
        self.set_y_position_short_sleeve_overlay()
        self.set_font_curve()
        self.set_font_size()
        self.set_number_size_back()
        self.set_shorts_number_size()
        self.set_front_number_size()
        self.set_y_position_back_number()
        self.set_x_position_front_number()
        self.set_y_position_front_number()
        self.set_x_position_shorts_number()
        self.set_y_position_shorts_number()
    ...
    def set_y_position_long_sleeve_overlay(self):
        self.y_position_long_sleeve_overlay = self.data[62]

    def update_y_position_long_sleeve_overlay(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 10
    ...
    def set_y_position_back_number(self):
        """
        """
        self.y_position_back_number = self.data[67]

    def update_y_position_back_number(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 18
    ...
    def set_y_position_front_number(self):
        """
        """
        self.y_position_front_number = self.data[69]

    def update_y_position_front_number(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 29
    ...
    def set_x_position_front_number(self):
        """
        """
        self.x_position_front_number = self.data[70]

    def update_x_position_front_number(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 29
    ...
    def set_y_position_shorts_number(self):
        """
        """
        self.y_position_shorts_number = self.data[72]

    def update_y_position_shorts_number(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 19
    ...
    def set_x_position_shorts_number(self):
        """
        """
        self.x_position_shorts_number = self.data[73]

    def update_x_position_shorts_number(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 25
    ...
    def set_shorts_number_size(self):
        """
        """
        self.shorts_number_size = self.data[74]

    def update_shorts_number_size(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 28 #18
    ...
    def set_y_position_font_shirt(self): #
        """
        """
        self.y_position_font_shirt = self.data[75]

    def update_y_position_font_shirt(self, new_value:int):
        """
        """
        min_value = 0
        max_value = 27
    ...
    def set_model_type(self):
        ...
        """
        self.model_type = self.data[82]

    def update_model_type(self, new_value:int):
        """
        Actualiza el model en el kit
        """
        min_value = 0
